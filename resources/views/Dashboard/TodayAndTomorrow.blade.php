    ...
    <div class="row">
        <div class="col-sm-6 m-2">
            <div class="card">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        @if (0<count($combineAllInformation_today_NOC))
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-sm-2">
                        @if (1<count($combineAllInformation_today_NOC))
                        <div class="card">
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        @if (3<count($combineAllInformation_today_NOC))
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-sm-2">
                        @if (4<count($combineAllInformation_today_NOC))
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-sm-2">
                        @if (5<count($combineAllInformation_today_NOC))
                        <div class="card">
                            <div class="card-body">
            ...
            <div class="card">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        @if (0<count($combineAllInformation_today_Factory))
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-sm-2">
                        @if (1<count($combineAllInformation_today_Factory))
                        <div class="card">
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        @if (3<count($combineAllInformation_today_Factory))
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-sm-2">
                        @if (4<count($combineAllInformation_today_Factory))
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-sm-2">
                        @if (5<count($combineAllInformation_today_Factory))
                        <div class="card">
                            <div class="card-body">
        ...
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        @if (0<count($combineAllInformation_tomorrow_NOC))
                        <div class="card">
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        @if (3<count($combineAllInformation_tomorrow_NOC))
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-sm-2">
                        @if (4<count($combineAllInformation_tomorrow_NOC))
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-sm-2">
                        @if (5<count($combineAllInformation_tomorrow_NOC))
                        <div class="card">
                            <div class="card-body">
            ...
            <div class="card">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        @if (0<count($combineAllInformation_tomorrow_Factory))
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-sm-2">
                        @if (1<count($combineAllInformation_tomorrow_Factory))
                        <div class="card">
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        @if (3<count($combineAllInformation_tomorrow_Factory))
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-sm-2">
                        @if (4<count($combineAllInformation_tomorrow_Factory))
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-sm-2">
                        @if (5<count($combineAllInformation_tomorrow_Factory))
                        <div class="card">
                            <div class="card-body">
