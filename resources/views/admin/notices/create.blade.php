                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"id="noticeDetails" />
                            <span class="text-danger" id="noticeDetailsError" ></span>
                        </div>
                        <div class="form-group">
                            <table class="table table-striped">
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" class="form-control" id="noticeStatus" />
